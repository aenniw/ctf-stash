...
Agent, you have been temporarily assigned to navy command. Your next mission is to win the most crucial naval battle.You have to win at least 80 out of 100 matches to get the flag. Be careful, the naval drones system interface is still in early beta. `nc challenges.thecatch.cz 8000` The bridge is yours, sir.
